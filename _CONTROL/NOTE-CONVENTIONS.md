# BrainVault Note Conventions

Diese Konvention gilt fuer neue oder wesentlich geaenderte Obsidian-Notizen im
BrainVault, besonders fuer Dateien unter `Research/`, `Data/Processed/` und
verarbeitete `_INBOX/`-Inhalte.
...
erstellt: YYYY-MM-DD
session: dispatcher|SESSION-A|SESSION-B|SESSION-C|SESSION-D|SESSION-E|subagent
...
- Domain: `homelab`, `mailpilot`, `brainvault`, `dsgvo`, `qa`
- Technologie: `docker`, `linux-host`, `slack`, `anthropic`, `caddy`
...
tags: [mailpilot, dsgvo, anthropic, slack, analyse]
...
Mail-Assistent-Claude-Slack-DSGVO-Kosten-Analyse.md
...
[^paperless-compose]: `/Users/Shared/GIT/homelab/mac-mini/paperless/florian/docker-compose.postgres.yml`, Services `webserver`, `db`, `broker`, gelesen am YYYY-MM-DD.
```
